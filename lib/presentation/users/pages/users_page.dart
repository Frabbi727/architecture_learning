...
import 'package:architecture_learning/presentation/users/widgets/user_form_dialog.dart';
import 'package:architecture_learning/presentation/users/widgets/user_tile.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '$totalUsers users loaded from the mock repository.',
